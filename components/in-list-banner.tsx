...
export function InListBanner({ site, badgeText, badgeColor }: InListBannerProps) {
  return (
    <div className="relative bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg p-3 sm:p-4 lg:p-6 border-2 border-dashed border-yellow-500 my-3 sm:my-4 lg:my-6 overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="relative z-10">
        ...
        <div className="block sm:hidden">
          ...
          {/* Mobile: Terms */}
          <div className="text-xs text-gray-400 text-center">18+ GambleAware.org. New customers only. T&Cs apply.</div>
        </div>
